...
## Required parameters
flags.DEFINE_string(
    "bert_config_file", "/home/none404/hm/PingAn/data/word_corpus/model/bert_config.json",
    "The config json file corresponding to the pre-trained BERT model. "
    "This specifies the model architecture.")

flags.DEFINE_string(
    "input_file", "/home/none404/hm/PingAn/data/word_corpus/word_corpus_256.record",
    "Input TF example files (can be a glob or comma separated).")

flags.DEFINE_string(
    "output_dir", '/home/none404/hm/PingAn/data/word_corpus/model/',
...
flags.DEFINE_integer("num_train_steps", 1200000, "Number of training steps.")
...
def model_fn_builder(bert_config, init_checkpoint, learning_rate,
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    (next_sentence_loss, next_sentence_example_loss, # TODO TODO TODO 可以计算但不算成绩
